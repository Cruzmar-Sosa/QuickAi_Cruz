...
import {Eraser, Image, Hash, House, SquarePen, Scissors, FileText, User, LogOut} from 'lucide-react'
...
const Sidebar = ({ sidebar, setSidebar }) => {
    ...
    // Access user information from Clerk
    // This will allow you to display user details in the sidebar
    const { user } = useUser();
  ...
  return (
    <div className={`w-60 bg-white border-r border-gray-200 flex flex-col justify-between items-center max-sm:absolute top-14 bottom-0 ${sidebar ? 'translate-x-0' : 'max-sm:-translate-x-full'} transition-all duration-300 ease-in-out`}>
        ...
        <div className='w-full border-t borger-gray-200 p-4 px-7 flex items-center justify-between'>
